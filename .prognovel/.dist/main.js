...
var WORKING_FOLDER = path__default['default'].resolve(__dirname, "../novels");
    ...
    return F___CODE_proyek_prognovelContents_node_modules__babel_runtime_regenerator.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            outputFolder = path__default['default'].resolve(input, "../.publish");
            if (!fs__default['default'].existsSync(outputFolder)) fs__default['default'].mkdirSync(outputFolder);
                ...
                if (size !== "placeholder") {
                  if (format === "webp") {
                    for (var i = 1; i <= loop; i++) {
                      ...
                      sharp__default['default'](input).resize(sizes[size][0] * i, sizes[size][1] * i).webp({
                        quality: quality,
                        reductionEffort: 6
                    ...
                    for (var _i = 1; _i <= loop; _i++) {
                      ...
                      sharp__default['default'](input).resize(sizes[size][0] * _i, sizes[size][1] * _i).jpeg({
                        quality: quality
            ...
            _context.next = 10;
            return sharp__default['default'](input).resize(placeholderSizes[0], placeholderSizes[1]).jpeg({
              quality: 25
            }).toBuffer();
  ...
  _appendNovelsMetadata = asyncToGenerator( /*#__PURE__*/F___CODE_proyek_prognovelContents_node_modules__babel_runtime_regenerator.mark(function _callee(novelsMetadata) {
    ...
    return F___CODE_proyek_prognovelContents_node_modules__babel_runtime_regenerator.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            siteMetadataFile = path__default['default'].resolve(__dirname, "../../sitemetadata.json");
            siteMetadata = JSON.parse(fs$2.readFileSync(siteMetadataFile, "utf-8"));
...
function checkValidBookFolder(folder) {
  var settingsFile = path__default['default'].resolve(__dirname, "../../site-settings.yml");
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            appendGlobalNovelMetadata = function _appendGlobalNovelMet(folder) {
              ...
              try {
                novelContributors = F___CODE_proyek_prognovelContents_node_modules_jsYaml.load(fs__default['default'].readFileSync(folder + "/contributors.yml"));
              } catch (err) {
