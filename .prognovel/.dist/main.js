...
function ensurePublishDirectoryExist(novel) {
  ...
  if (!novel) return;
  folder.novel = path__default['default'].join(folder.publish, "/".concat(novel));
...
function _compileChapter() {
  _compileChapter = asyncToGenerator( /*#__PURE__*/F___CODE_proyek_prognovelCli_node_modules__babel_runtime_regenerator.mark(function _callee4(folder, images, id) {
          ...
          case 0:
            return _context4.abrupt("return", new Promise( /*#__PURE__*/function () {
              var _ref2 = asyncToGenerator( /*#__PURE__*/F___CODE_proyek_prognovelCli_node_modules__babel_runtime_regenerator.mark(function _callee3(resolve) {
                ...
                var novel, chapters, chapterTitles, contributions, unregisteredContributor, t0, glob0, files, glob1, cacheFolder, cacheFile, cache, rev0, rev_share, rev1, ch0, chapterList, ch1, info, synopsis, meta, logTitle, publishFolder, t1;
                  ...
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      ...
                      case 9:
                        ...
                        cacheFolder = path__default['default'].join(process.cwd(), "/.cache");
...
function generateSiteSettings() {
  ...
  var metadataFile = path__default['default'].resolve(publishFolder, "/sitemetadata.json"); // console.log(metadataFile);
