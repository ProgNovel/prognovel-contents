...
import fs$2, { readFileSync, writeFileSync } from 'fs';
...
var F___CODE_proyek_prognovelContents_node_modules__babel_runtime_regenerator = runtime_1;
...
var WORKING_FOLDER = path.resolve(__dirname, "../novels");
...
function _generateBookCover() {
  _generateBookCover = asyncToGenerator( /*#__PURE__*/F___CODE_proyek_prognovelContents_node_modules__babel_runtime_regenerator.mark(function _callee(input) {
    var outputFolder,
        images,
        placeholderSizes,
        buffer;
    return F___CODE_proyek_prognovelContents_node_modules__babel_runtime_regenerator.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            outputFolder = path.resolve(input, "../.publish");
            if (!fs$2.existsSync(outputFolder)) fs$2.mkdirSync(outputFolder);
                ...
                if (size !== "placeholder") {
                  if (format === "webp") {
                    for (var i = 1; i <= loop; i++) {
                      ...
                      sharp(input).resize(sizes[size][0] * i, sizes[size][1] * i).webp({
                        quality: quality,
                        reductionEffort: 6
                    ...
                    for (var _i = 1; _i <= loop; _i++) {
                      ...
                      sharp(input).resize(sizes[size][0] * _i, sizes[size][1] * _i).jpeg({
                        quality: quality
            ...
            _context.next = 10;
            return sharp(input).resize(placeholderSizes[0], placeholderSizes[1]).jpeg({
              quality: 25
            }).toBuffer();
...
function appendNovelsMetadata(_x) {
  return _appendNovelsMetadata.apply(this, arguments);
}

function _appendNovelsMetadata() {
  _appendNovelsMetadata = asyncToGenerator( /*#__PURE__*/F___CODE_proyek_prognovelContents_node_modules__babel_runtime_regenerator.mark(function _callee(novelsMetadata) {
    var siteMetadataFile, siteMetadata;
    return F___CODE_proyek_prognovelContents_node_modules__babel_runtime_regenerator.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            siteMetadataFile = path.resolve(__dirname, "../../sitemetadata.json");
            siteMetadata = JSON.parse(readFileSync(siteMetadataFile, "utf-8"));
...
var F___CODE_proyek_prognovelContents_node_modules_jsYaml = jsYaml;
...
function parse$1 (string) {
  ...
  var attributes = F___CODE_proyek_prognovelContents_node_modules_jsYaml.load(yaml) || {};
...
var defaults$3 = createCommonjsModule(function (module) {
function getDefaults() {
  return {
    baseUrl: null,
    breaks: false,
...
var defaults_1$1 = defaults$3.defaults;
var defaults_2$1 = defaults$3.getDefaults;
var defaults_3$1 = defaults$3.changeDefaults;
...
const { defaults: defaults$5 } = defaults;
const {
  unescape: unescape$1
} = helpers;
...
var path_2 = path_1.removeLeadingDotSegment;
var path_3 = path_1.escape;
var path_4 = path_1.makeAbsolute;
var path_5 = path_1.unixify;
...
var pattern_1 = pattern$1.matchAny;
var pattern_2 = pattern$1.convertPatternsToRe;
var pattern_3 = pattern$1.makeRe;
var pattern_4 = pattern$1.getPatternParts;
var pattern_5 = pattern$1.expandBraceExpansion;
var pattern_6 = pattern$1.expandPatternsWithBraceExpansion;
var pattern_7 = pattern$1.isAffectDepthOfReadingPattern;
var pattern_8 = pattern$1.endsWithSlashGlobStar;
var pattern_9 = pattern$1.hasGlobStar;
var pattern_10 = pattern$1.getBaseDirectory;
var pattern_11 = pattern$1.getPositivePatterns;
var pattern_12 = pattern$1.getNegativePatterns;
var pattern_13 = pattern$1.isPositivePattern;
var pattern_14 = pattern$1.isNegativePattern;
var pattern_15 = pattern$1.convertToNegativePattern;
var pattern_16 = pattern$1.convertToPositivePattern;
var pattern_17 = pattern$1.isDynamicPattern;
var pattern_18 = pattern$1.isStaticPattern;
...
var string_1 = string.isEmpty;
var string_2 = string.isString;
...
var utils_1$2 = utils$2.string;
var utils_2$2 = utils$2.stream;
var utils_3$2 = utils$2.pattern;
var utils_4$2 = utils$2.path;
var utils_5$2 = utils$2.fs;
var utils_6$2 = utils$2.errno;
var utils_7$2 = utils$2.array;
...
unwrapExports(tasks);
var tasks_1 = tasks.convertPatternGroupToTask;
var tasks_2 = tasks.convertPatternGroupsToTasks;
var tasks_3 = tasks.groupPatternsByBaseDirectory;
var tasks_4 = tasks.getNegativePatternsAsPositive;
var tasks_5 = tasks.getPositivePatterns;
var tasks_6 = tasks.convertPatternsToTasks;
var tasks_7 = tasks.generate;
...
function checkValidBookFolder(folder) {
  var settingsFile = path.resolve(__dirname, "../../site-settings.yml");
  var settings = F___CODE_proyek_prognovelContents_node_modules_jsYaml.safeLoad(fs$2.readFileSync(settingsFile));
  var isInfoExist = fs$2.existsSync(folder + "/info.yml");
  var isSynopsisExist = fs$2.existsSync(folder + "/synopsis.md");
...
function _generateMetadata() {
  _generateMetadata = asyncToGenerator( /*#__PURE__*/F___CODE_proyek_prognovelContents_node_modules__babel_runtime_regenerator.mark(function _callee2(novels) {
    var firstNovel, folders, appendGlobalNovelMetadata;
    return F___CODE_proyek_prognovelContents_node_modules__babel_runtime_regenerator.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            appendGlobalNovelMetadata = function _appendGlobalNovelMet(folder) {
              ...
              try {
                novelContributors = F___CODE_proyek_prognovelContents_node_modules_jsYaml.load(fs$2.readFileSync(folder + "/contributors.yml"));
              } catch (err) {
          ...
          case 4:
            ...
            return _context2.abrupt("return", Promise.all(folders.map( /*#__PURE__*/function () {
              var _ref = asyncToGenerator( /*#__PURE__*/F___CODE_proyek_prognovelContents_node_modules__babel_runtime_regenerator.mark(function _callee(folder) {
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        _context.next = 9;
                        return generateBookCover(folder + "/cover.jpg", placeholderRatio);
...
function _compileChapter() {
  _compileChapter = asyncToGenerator( /*#__PURE__*/F___CODE_proyek_prognovelContents_node_modules__babel_runtime_regenerator.mark(function _callee4(folder, images, id) {
    return F___CODE_proyek_prognovelContents_node_modules__babel_runtime_regenerator.wrap(function _callee4$(_context4) {
      while (1) {
          ...
          case 0:
            return _context4.abrupt("return", new Promise( /*#__PURE__*/function () {
              var _ref2 = asyncToGenerator( /*#__PURE__*/F___CODE_proyek_prognovelContents_node_modules__babel_runtime_regenerator.mark(function _callee3(resolve) {
                var novel, chapters, chapterTitles, contributions, files, rev_share, chapterList, info, synopsis, meta;
                  ...
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      ...
                      case 6:
                        ...
                        console.log("Found", files.length, "markdowns for novel", novel + ".");
                        files.forEach(function (file) {
                          var meta = frontMatter(fs$2.readFileSync(file, "utf-8"));
                        ...
                        info = F___CODE_proyek_prognovelContents_node_modules_jsYaml.load(fs$2.readFileSync(folder + "/info.yml", "utf8"));

                        if (!Array.isArray(info.paymentPointers)) {
                          info.paymentPointers = [info.paymentPointers];
                        }

                        synopsis = marked_1(fs$2.readFileSync(folder + "/synopsis.md", "utf8"));
                        ...
                        fs$2.writeFileSync(folder + "/.publish/metadata.json", JSON.stringify(meta, null, 4));
                        fs$2.writeFileSync(folder + "/.publish/chapter-titles.json", JSON.stringify(chapterTitles));
                        resolve(meta);
...
function convertToNumeric(chapterName) {
  ...
  var splitString = chapterName.replace("chapter-", "").replace(".md", "");
...
function generateSiteSettings() {
  ...
  var metadataFile = path.resolve(__dirname, "../../sitemetadata.json");
  console.log(metadataFile);
  fs$2.writeFileSync(metadataFile, JSON.stringify(settings, null, 4));
